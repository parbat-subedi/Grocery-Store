		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} {{CURRENT_ITEM}} .premium-drawable-icon svg, {{WRAPPER}} {{CURRENT_ITEM}} .premium-drawable-icon svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$repeater_list->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} {{CURRENT_ITEM}} .premium-drawable-icon svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$repeater_list->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}}  {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-drawable-icon svg, {{WRAPPER}}  {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-drawable-icon svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$repeater_list->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} {{CURRENT_ITEM}}.premium-bullet-list-content:hover .premium-drawable-icon svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-drawable-icon svg, {{WRAPPER}} .premium-drawable-icon svg *' => 'fill: {{VALUE}};',
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-drawable-icon svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-bullet-list-content:hover .premium-drawable-icon svg' => 'fill: {{VALUE}}; color: {{VALUE}}',
				),
			)
		);
		...
		if ( $draw_icon ) {
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .premium-bullet-list-content:hover .premium-drawable-icon svg *' => 'stroke: {{VALUE}};',
					),
				)
			);
		}
